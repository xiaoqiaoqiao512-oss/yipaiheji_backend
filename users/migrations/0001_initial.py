    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', '普通学生'), ('creator', '创作者'), ('admin', '管理员')], default='student', max_length=20, verbose_name='角色')),
                ...
                ('student_card_img', models.ImageField(blank=True, null=True, upload_to='student_cards/', verbose_name='学生卡照片')),
